...
class CoinWebPaymentScreen extends StatelessWidget {
  CoinWebPaymentScreen({
    super.key,});
  ...
  _bodyWidget(BuildContext context) {
    var paymentUrl = controller.coinGateModel.data.url;
    ...
    return InAppWebView(
      ...
      onLoadStop: (controller, url) {
        if (url.toString().contains('coingate/payment/success/')) {
          StatusScreen.show(
            context: context,
